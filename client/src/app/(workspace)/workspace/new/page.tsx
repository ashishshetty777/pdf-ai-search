      ...
      <div className="w-full max-w-xl rounded-md p-6">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center pb-4 mb-4 border-b border-gray-300">
            ...
            <label
              htmlFor="fileInput"
              className="px-4 py-2 text-[#002e5d] border-[#002e5d] border rounded-md 
          ...
          <div className="mt-4 text-sm font-medium text-[#002e5d] py-2 mb-5 rounded-lg">
            <p>
          ...
          <button
            type="submit"
            className="w-full py-3 text-lg font-medium text-white bg-[#002e5d] rounded-md 
